...
// Employee's own shifts view. Three sections:
//
//   1. Needs response  — PROPOSED assignments awaiting Confirm/Decline
//   2. Upcoming         — CONFIRMED assignments that haven't started
//   3. History          — past (COMPLETED) + DECLINED + NO_SHOW
//
// The Confirm/Decline actions are implemented as server actions that
// call PATCH /api/assignments/[id], keeping the REST API authoritative.
...
export default async function MyShiftsPage({ searchParams }: Props) {
  ...
  // Load assignments in parallel, split by status
