...
// Match the values in the applicant-flow form so labels stay consistent
...
// Helper to produce a datetime-local default value
...
export function NewShiftForm({ facilities }: Props) {
  ...
  if (facilities.length === 0) {
    return (
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-5 text-sm text-amber-800">
        No facilities exist yet. Create a facility account first before
        scheduling shifts.
      </div>
    );
  }
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <p className="mb-2 text-xs text-slate-500">
            ...
            employee type already requires. Leave empty to rely on baselines
            only.
          </p>
          <div className="flex flex-wrap gap-2">
